...
class ContactsApi
{
     ...
     */
    protected function deleteCharactersCharacterIdContactsRequest($character_id, $contact_ids, $datasource = 'tranquility', $token = null)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getAlliancesAllianceIdContactsRequest($alliance_id, $datasource = 'tranquility', $if_none_match = null, $page = '1', $token = null)
    {
    ...
    {
        $returnType = '\Swagger\Client\Model\GetAlliancesAllianceIdContactsLabels200Ok[]';
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getAlliancesAllianceIdContactsLabelsRequest($alliance_id, $datasource = 'tranquility', $if_none_match = null, $token = null)
    {
        // verify the required parameter 'alliance_id' is set
        if ($alliance_id === null || (is_array($alliance_id) && count($alliance_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getCharactersCharacterIdContactsRequest($character_id, $datasource = 'tranquility', $if_none_match = null, $page = '1', $token = null)
    {
        // verify the required parameter 'character_id' is set
        if ($character_id === null || (is_array($character_id) && count($character_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getCharactersCharacterIdContactsLabelsRequest($character_id, $datasource = 'tranquility', $if_none_match = null, $token = null)
    {
        // verify the required parameter 'character_id' is set
        if ($character_id === null || (is_array($character_id) && count($character_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getCorporationsCorporationIdContactsRequest($corporation_id, $datasource = 'tranquility', $if_none_match = null, $page = '1', $token = null)
    {
    ...
    {
        $returnType = '\Swagger\Client\Model\GetCorporationsCorporationIdContactsLabels200Ok[]';
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getCorporationsCorporationIdContactsLabelsRequest($corporation_id, $datasource = 'tranquility', $if_none_match = null, $token = null)
    {
        // verify the required parameter 'corporation_id' is set
        if ($corporation_id === null || (is_array($corporation_id) && count($corporation_id) === 0)) {
            throw new \InvalidArgumentException(
        ...
        try {
            ...
            switch ($e->getCode()) {
                ...
                case 520:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\PostCharactersCharacterIdContactsError520',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
