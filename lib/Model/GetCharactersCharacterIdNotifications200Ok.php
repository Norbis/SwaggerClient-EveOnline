...
class GetCharactersCharacterIdNotifications200Ok implements ModelInterface, ArrayAccess
{
    ...
    const TYPE_STRUCTURE_IMPENDING_ABANDONMENT_ASSETS_AT_RISK = 'StructureImpendingAbandonmentAssetsAtRisk';
    ...
    const TYPE_WAR_ENDED_HQ_SECURITY_DROP = 'WarEndedHqSecurityDrop';
